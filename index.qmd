...
O inventário deve conter o diâmetro, a a identificação botânica e as coordenadas de todos as árvores com menos de um determinado diâmetro (normalmente DAP \>= 10cm).
