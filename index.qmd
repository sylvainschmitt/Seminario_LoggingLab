...
A máscara do lote define os limites da área a ser registrada <!-- not sure registrada is the right term... a ser considerada ?--> ou seja, os limites do lote. A máscara do lote é usada pelo `LoggingLab` para validar o inventário e definir a zonas exploráveis.
...
-   `Aggregative`: Natureza agregadora da espécie para converter árvores isoladas <!-- not sure converter is the right word... evitar ?
...
::: incremental
- uma área conectada a uma trilha de caminhão ou trilha principal de skidding
- com uma inclinação inferior a 27%
- evitando planícies e o sistema de água (buffer de 30 m).
::: 

<!-- maybe don't talk about piste à camions to avoid spending time on vocabulary?--> 
...
As áreas verdes claras podem ser colhidas (áreas verde-escuras podem ser colhidas por máquina e verde-claro com cabo). As outras áreas são as áreas não exploráveis (areas baixas com o sistema de água).
...
As árvores futuras são aqueles a serem explorados na próxima campanha. 
As árvores de reserva são conservadas como árvores-semente para regeneração natural.
...
O corte direcional visa direcionar a queda da árvore, com o pé um ângulo em relação ao caminho, e evitando as árvores a serem protegidas.
